defmodule ZiglerTest.Snapshot.LongRunningTest do
  ...
  describe "resource_struct/1 generates a zig struct" do
    test "for a 0-arity function" do
      ...
      """ == LongRunning.cache_struct(%{name: :foo, args: [], retval: "i64"})
    end
    ...
    test "for a 1-arity function" do
      ...
      """ == LongRunning.cache_struct(%{name: :foo, args: ["i64"], retval: "i64"})
    end
    ...
    test "for a 2-arity function, with a different name and retval" do
      ...
      """ == LongRunning.cache_struct(%{name: :bar, args: ["i64", "f64"], retval: "f64"})
    end
  end
  ...
  describe "launch_fn/1 generates a zig function" do
    test "for a 0-arity function" do
      ...
      """ == LongRunning.launcher_fn(%{name: :foo, args: [], retval: "i64"})
    end
    ...
    test "for function with a different name" do
      ...
      """ == LongRunning.launcher_fn(%{name: :bar, args: ["i64"], retval: "i64"})
    end
  end
  ...
  describe "packer_fn/1 generates a zig function" do
    test "for a 0-arity function" do
      ...
      """ == LongRunning.packer_fn(%{name: :foo, args: [], retval: "i64"})
    end
    ...
    test "for a 2-arity function with a different name" do
      ...
      """  == LongRunning.packer_fn(%{name: :foo, args: ["i64", "f64"], retval: "i64"})
    end
  end
  ...
  describe "harness_fn/1 generates a zig function" do
    test "for a 0-arity function" do
      ...
      """ == LongRunning.harness_fn(%{name: :foo, args: [], retval: "i64"})
    end
    ...
    test "for a 2-arity function with a different name" do
      ...
      """ == LongRunning.harness_fn(%{name: :bar, args: ["i64", "f64"], retval: "i64"})
    end
    ...
    test "for a void retval function" do
      ...
      """ == LongRunning.harness_fn(%{name: :foo, args: [], retval: "void"})
    end
  end
  ...
  describe "fetcher_fn/1 generates a zig function" do
    test "for a function with a generic retval" do
      ...
      """ == LongRunning.fetcher_fn(%{name: :foo, args: [], retval: "i64"})
    end
    ...
    test "for a function with void retval" do
      ...
      """ == LongRunning.fetcher_fn(%{name: :foo, args: [], retval: "void"})
    end
  end
end
